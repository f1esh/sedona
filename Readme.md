...
* Студент: [Rinat]({{https://github.com/f1esh}}).
...
[Откройте мастер-репозиторий](git@github.com:f1esh/sedona.git) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
